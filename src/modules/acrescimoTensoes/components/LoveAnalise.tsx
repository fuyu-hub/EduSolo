...
import { exportToPDF, exportToExcel, ExportData, ExcelExportData, formatNumberForExport } from "@/lib/utils/export-utils";
import { useSettings } from "@/hooks/use-settings";
import { useTheme } from "@/hooks/use-theme";
import { calcularAcrescimoTensoes } from "@/modules/acrescimoTensoes/calculations";
...
export default function LoveAnalise({ onVoltar, onLoadExampleRef }: LoveAnaliseProps) {
  // Configurações
