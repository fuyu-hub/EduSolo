...
import { calcularGranulometria } from "./calculos";
...
import TabelaDadosGranulometricos from "./componentes/TabelaDadosGranulometricos";
import CurvaGranulometrica from "./componentes/CurvaGranulometrica";
import DialogExemplos from "./componentes/DialogExemplos";
import PlasticityChart from "@/modulos/granulometria/componentes/CartaPlasticidade";
import { type ExemploGranulometria } from "./exemplos";

import type { GranulometriaOutput, PontoGranulometrico } from "./types";
import { useGranulometriaLabStore as useGranulometriaStore, type PeneiraDado, type PeneiramentoGrossoData, type PeneiramentoFinoData } from "./store";
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Tooltip>
                          <TooltipTrigger>
                            <Info className="w-3 h-3 text-white opacity-100 hover:opacity-80 transition-opacity" />
                          </TooltipTrigger>
      ...
      <div className="flex items-center gap-1.5">
        ...
        {tooltip && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <Info className="w-3.5 h-3.5 text-white opacity-100 hover:opacity-80 transition-opacity" />
              </TooltipTrigger>
