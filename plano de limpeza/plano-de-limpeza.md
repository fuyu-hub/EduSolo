...
## Fase 1 — Limpeza Superficial *(Risco Baixo)* ✅ CONCLUÍDA
...
### 1.4 Verificar e Limpar WelcomeDialog ✅ (Mantido)
...
### 2.2 Eliminar Stubs de Re-export em `lib/` ⏳ PRÓXIMO
...
### 2.3 Eliminar Stubs Deprecated em `lib/calculations/` ⏳ PRÓXIMO
